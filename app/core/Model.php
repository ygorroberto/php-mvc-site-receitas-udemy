...
class Model {
    ...
    /**
     * Create a database connection or return the connection already open using Singleton Design Patern
    ...
    /**
     * Rollback changes on opened transaction
     * @return void
     */
    ...
    /**
     * return the result of a query (select) of only one row
    ...
    /**
     * return the result of a query (select)
     * @param string $sql the sql string
     * @param array $params the array of parameters (array(":col1" => "val1", "col2" => "val2"))
