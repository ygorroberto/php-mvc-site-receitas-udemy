...
<form action="{{BASE}}receita/alterar/{{receitaId}}" onsubmit="return validar(true);" method="post">
    <div class="row">
        ...
        <div class="col-md-4 mt-3">
            ...
            <input type="text" id="txtSlug" name="txtSlug" class="form-control" placeholder="título-aqui" value="{{receita.slug}}">
        </div>
    ...
    <div class="row">
        <div class="col-md-12 mt-3">
            ...
            <input type="text" id="txtLinhaFina" name="txtLinhaFina" class="form-control" placeholder="Escreva a receita" minlength="10" maxlength="250" value="{{receita.linhaFina}}">
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-12 mt-3">
            ...
            <input type="text" id="txtThumb" name="txtThumb" class="form-control" placeholder="http://mysite.com/img/img.jpg" minlength="1" maxlength="250" value="{{receita.thumb}}">
        </div>
    </div>
