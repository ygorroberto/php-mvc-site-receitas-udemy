...
<form action="{{BASE}}receita/inserir" onsubmit="return validar(false);" method="post">
    ...
    <div class="row">
        <div class="col-md-12 mt-3">
            ...
            <input type="text" id="txtThumb" name="txtThumb" class="form-control" placeholder="http://mysite.com/img/img.jpg" minlength="10" maxlength="250">
        </div>
    </div>
